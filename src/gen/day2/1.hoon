...
::  contains 30, and position 10 contains 40. Add these numbers together to get 70.
::  Then, store this value at the output position; here, the output position (3) is
...
:-  %say
|=  *
=/  ops=(list @)   (weld ~[-:program] +:program)
=/  prog=(list @)  (weld ~[-:program] +:program)
=|  i=@
:-  %noun
|-  ^-  @
?~  ops
